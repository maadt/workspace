...
public class VendingMachine {//基軸となるクラス
private static final BufferedReader BR = new BufferedReader(new InputStreamReader(System.in));//安全性を考慮して定数とする
...
private int select = 0;
    ...
    private void checkDeposit() {
        ...
        while (deposit < price) {//値段に対して入金額が不足している場合の繰り返し処理
    ...
    private void getChange() {
        ...
        if (change > 0) {
            System.out.println(this.deposit.getChangeAndInit(change) + " 円のお返しです");
        }
    }
    // 全在庫数の確認
